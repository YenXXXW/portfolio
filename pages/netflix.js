  ...
  return (
    <div className="w-full ">
      <div className="w-full h-[40vh] lg:h-[50vh] relative">
        <div
          className="absolute top-0 left-0 w-full h-[40vh] lg:h-[50vh]
                bg-black/40 z-10"
        />
        <Image
      ...
      <div className="max-w-[1240px] mx-auto p-10 grid md:grid-cols-5 gap-8 pt-8 ">
        <div className="col-span-4">
          ...
          <div className="max-w-2xl my-4">
            A Nextjs netflix clone project.Hosted on{" "}
            <span className="text-[#5651e5]">Vercel </span>
            and cosumes the api provided by TMDB.Can view the real time movie
            data eg. Trending Movies, best rated movies , the plot summary etc.
          </div>
          <a
